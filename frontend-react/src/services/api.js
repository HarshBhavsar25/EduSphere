...
const api = {
    ...
    // AI
    analyzeResume: (d) => api.request('/api/ai/analyze-resume', { method: 'POST', body: d instanceof FormData ? d : JSON.stringify(d) }),
    ...
    matchJobsWithResume: (data) => api.request('/api/ai/job-match-resume', { method: 'POST', body: data }),
